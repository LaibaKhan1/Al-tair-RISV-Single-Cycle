...
val a = Cat(Fill(20, io.instr(31)), io.instr(31), io.instr(7), io.instr(30, 25), io.instr(11,8), "b0".U).asSInt
io.SB_Type := a + io.pc.asSInt
        
io.U_Type := Cat(Fill(20, io.instr(31)), io.instr(31, 12)).asSInt
        
val b = Cat(Fill(20, io.instr(31)), io.instr(31), io.instr(19, 12), io.instr(11), io.instr(19,1)).asSInt
