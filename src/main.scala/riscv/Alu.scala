...
class ALU extends Module with Config {
    ...
    val out = 
    Mux(io.alu_Op === ALU_ADD || io.alu_Op === ALU_ADDI || io.alu_Op === ALU_LW || io.alu_Op === ALU_SW, (io.in_A + io.in_B),
    Mux(io.alu_Op === ALU_SLL || io.alu_Op === ALU_SLLI,(io.in_A.asUInt << io.in_B(18,0)).asSInt,
    Mux(io.alu_Op === ALU_SLT || io.alu_Op === ALU_SLTI,(io.in_A < io.in_B).asSInt,
    Mux(io.alu_Op === ALU_SLTUI || io.alu_Op === ALU_SLTU,(io.in_A.asUInt < io.in_B(18,0).asUInt).asSInt,
